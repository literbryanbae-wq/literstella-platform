...
export const LYRA_POINT_LEVELS = Object.freeze([
  ...
  Object.freeze({ key: 'tutor', label: 'Tutor', minPoints: 1500, nextPoints: 3000 }),
  Object.freeze({ key: 'soul', label: 'Soul', minPoints: 3000, nextPoints: null }),
]);
...
// Only verified positive earnings advance Lyra. Spending and manual balance
// corrections never lower or raise the companion mode.
