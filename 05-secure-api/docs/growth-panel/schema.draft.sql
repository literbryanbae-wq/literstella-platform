...
-- Covers auth.users ON DELETE CASCADE without scanning every campaign/application row.
create index growth_panel_auth_uid_idx on public.growth_panel_applications(auth_uid);
